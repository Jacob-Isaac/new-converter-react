      ...
      content =
        <>
          ...
          <FormResult
            ...
            id="TU JEST WYNIK">
            {resultValue}
          </FormResult>{messageFromApi ==="almostOk" ? <Error>Błąd serwera. Chwilowo korzystasz z nieaktualnych kursów walut.</Error> : <p>Kursy walut są pobierane z <b>Europejskiego Banku Centralnego</b></p>}
        </>
      break;
      case "almostError":
      content =         <Error>
